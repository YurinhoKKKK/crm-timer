...
// nesta página, agora é tela própria em /colaborador/validacoes. Mantemos este
// redirecionamento porque há links salvos e em conversas antigas apontando aqui.
export default function ColaboradorMensagensRedirect() {
  redirect("/colaborador/validacoes");
}
