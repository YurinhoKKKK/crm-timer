...
// nesta página, agora é tela própria em /consultor/validacoes. Mantemos este
// redirecionamento porque há links salvos e em conversas antigas apontando aqui.
export default function ConsultorMensagensRedirect() {
  redirect("/consultor/validacoes");
}
